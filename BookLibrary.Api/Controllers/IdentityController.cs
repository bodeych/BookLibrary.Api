...
public class IdentityControllers : ControllerBase
{
    ...
    public async Task<IActionResult> LoginUser([FromBody] UserLoginRequest request, CancellationToken cancellationToken)
    {
        ...
        var loginCommand = new LoginUserCommand() { Username = request.Username, Password = request.Password };
        ...
        {
            AccessToken = loginTokens.AccessToken, RefreshToken = loginTokens.RefreshToken
        };
    ...
    public async Task<IActionResult> RegistrationUser([FromBody] UserRegistrationRequest request,
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            AccessToken = newToken.AccessToken, RefreshToken = newToken.RefreshToken
        };
